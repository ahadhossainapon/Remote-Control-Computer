...
public class Keyboard extends Activity implements OnTouchListener, OnClickListener,
	...
	private void addText(View v) {
		if (isEdit == true) {
			String b = "";
			b = (String) v.getTag();
			final String keyboardLetter = "$"+b;
			byte[] keyboard_letter = keyboardLetter.getBytes();
			RemoteBluetooth.mCommandService.write(keyboard_letter);
			if (b != null) {
			...
			if (cc != null && cc.length() > 0) {
				{
					...
					final String backkey = "$"+"backkeypressed";
					byte[] keyboard_letter = backkey.getBytes();
					RemoteBluetooth.mCommandService.write(keyboard_letter);
